      ...
      <div className="">
        <div className="bg-black max-w-screen mx-auto px-4">
          <div className="flex justify-between">
            ...
            <div className="hidden md:flex space-x-1 align-left">
              <Link href="/events">
                <a className="py-7 px-3 text-gray-100 hover:text-gray-600">
                  Events
                </a>
              </Link>
              <Link href="/about">
              ...
              <a
                href="https://shop.dirtynotsorry.com"
                className="py-7 px-3 text-gray-100 hover:text-gray-600"
              >
                Shop
              </a>
            </div>
        ...
        <div className="sidebar min-h-screen bg-black text-white w-64 space-y-6 px-2 py-7 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out md:hidden">
          ...
          <Link href="/">
            <a
              href="/"
              className="text-gray-200 flex items-center p-4 rounded transition duration-200 hover:bg-gray-400 hover:text-white"
            >
              Dirty Not Sorry
            </a>
          </Link>
          ...
          <nav>
            <Link href="/events">
              <a className="block py-3 px-4 rounded transition duration-200 hover:bg-gray-400 hover:text-white">
                Events
              </a>
            </Link>
            <Link href="/about">
            ...
            <Link href="/contact">
              <a
                href="/contact"
                className="block py-3 px-4 rounded transition duration-200 hover:bg-gray-400 hover:text-white"
              >
                Contact
              </a>
            </Link>
